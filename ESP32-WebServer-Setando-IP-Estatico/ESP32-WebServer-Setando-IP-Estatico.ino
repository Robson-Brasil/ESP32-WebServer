...
void setup() {
  ...
  Serial.println("Endreco de IP: ");
  Serial.println(WiFi.localIP());
   // Print ESP MAC Address
  Serial.println("Endereco do MAC: ");
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("Conexao Encerrada");
            client.println();
            ...
            client.println("<p>Botao 1 - Estado " + output26State + "</p>");
            ...
            client.println("<p>Botao 2 - Estado " + output27State + "</p>");
